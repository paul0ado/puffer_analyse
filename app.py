...
if uploaded_file is not None:
    try:
        ...
        # FIX 1: Changed 'datenset' to 'auswahl'
        if auswahl == "Chargen":
        ...
        # Plot 1: Barplot
        # FIX 2: Removed stray ']' in arguments
        ...
        # FIX 3: Added closing parenthesis to string
        ax[0].set_ylabel("Gehalt (U/ml)") 
        
        # FIX 4: Updated 'datenset' to 'auswahl' here as well
        if auswahl == "Beides": 
        ...
        # FIX 5: Added missing comma before 'label'
        ...
        ax[2].legend(loc='upper right', bbox_to_anchor=(1.1, 1.1), fontsize=8, framealpha=0.9)
